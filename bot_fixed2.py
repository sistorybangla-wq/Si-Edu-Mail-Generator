...
def start_bot(start_url, email, college, collegeID, cookies, token):
    ...
    # driver.find_element(By.XPATH, '//*[@id="accountFormSubmit"]').click()
    ...
    if solved == 1:
        ...
        try:
            time.sleep(1)
            dropdown_menu = Select(driver.find_element(By.ID, 'inputMajorCategory'))
        ...
        try:
            element = driver.find_element(By.ID, 'inputHomelessYouthNo')
            desired_y = (element.size['height'] / 2) + element.location['y']
            window_h = driver.execute_script('return window.innerHeight')
            window_y = driver.execute_script('return window.pageYOffset')
            current_y = (window_h / 2) + window_y
        ...
        # driver.find_element(By.XPATH, '//*[@id="column2"]/div[7]/ol/li[2]/button').click()
        ...
        # driver.find_element(By.XPATH, '//*[@id="column2"]/div[9]/ol/li[2]/button').click()
        ...
        if collegeID == 1:
            ...
            # driver.find_element(By.XPATH, '//*[@id="applyForm"]/main/div[3]/div[5]/ol/li[2]/button').click()
            ...
            FA = Select(driver.find_element(By.ID, '_supp_MENU_1'))
            FA.select_by_value('B')
            time.sleep(2)

            PG = Select(driver.find_element(By.ID, '_supp_MENU_2'))
            PG.select_by_value('B')
            time.sleep(2)      

            SM = Select(driver.find_element(By.ID, '_supp_MENU_3'))
            SM.select_by_value('A')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_4'))
            SM.select_by_value('04')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_5'))
            SM.select_by_value('B')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_6'))
            SM.select_by_value('B')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_7'))
            SM.select_by_value('B')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_8'))
            SM.select_by_value('A')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_10'))
            SM.select_by_value('F')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_11'))
            SM.select_by_value('B')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_12'))
            SM.select_by_value('A')
            time.sleep(2)

            SM = Select(driver.find_element(By.ID, '_supp_MENU_13'))
            SM.select_by_value('B')
            time.sleep(2)

            driver.find_element(By.ID, "_supp_CHECK_4").click()

            driver.find_element(By.ID, "YESNO_4_yes").click()

            driver.find_element(By.ID, "YESNO_5_no").click()

            driver.find_element(By.ID, "YESNO_6_no").click()

            driver.find_element(By.ID, "YESNO_7_no").click()

            driver.find_element(By.ID, "YESNO_8_no").click()
        ...
        # driver.find_element(By.XPATH, '//*[@id="submit-application-button"]').click()
        element.click()
