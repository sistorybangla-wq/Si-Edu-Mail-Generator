...
def start_bot(start_url, email, college, collegeID, cookies, token):
    ...
    typex = fp.read()
    fp.close()  # 2026 Update - Close file properly
    try:
        # For Chrome
        if typex == 'chrome':
    ...
    for cookie in cookies.keys():
        ...
        try:
            ...
            print(fr + f'\nWarning: Could not add cookie {cookie}: {e}')
    print(fg + ' (success)')
    ...
    try:
        ...
        try:
            ...
            print(fr + f'Phone validation error: {e}')
    ...
    try:
        ...
        if solved == 1:
            ...
            # 2026 Update - Save with Registration No and Roll No
            ...
            try:
                ...
                print(fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fy + 'Application Progress - Continuing...' + fg + ' (Completed)')
                print(fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Your confirmation has been submitted!')
                
            except Exception as e:
                print(fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Application form submission completed')
        ...
        print(fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fr + f'Error during account creation: {e}')
        driver.close()

def main():
    sys.stdout.write(bannerTop())

    print(fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Si-Edu-Mail-Generator v2.0 (September 2026)')
    ...
    print('\\n' + fc + sd + '[' + fm + sb + '*' + fc + sd + '] ' + fg + 'Performing Incapsula Bypass (v2.0)')
